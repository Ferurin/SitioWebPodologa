...
<body class="text-center">
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="../src/login.php">Reserva de Horas</a>
                    </li>
                    <li class="nav-item">
    ...
    <main class="form-signin">
        <form action="./signUp.php" method="POST" name="registerUsuario">
            ...
            <button id="mostrarAlerta" class="w-100 btn btn-lg btn-primary" type="submit">Registrarte</button>
            ...
            <script>
                document.getElementById("mostrarAlerta").addEventListener("click", function() {
                    ...
                    if ($_SERVER['REQUEST_METHOD'] === 'POST') {
                        echo 'alert("Los datos fueron registrados correctamente.");';
                    }
                    ?>
                });
            </script>
